...
class c2c_Plugin extends WP_UnitTestCase {
	...
	public function test_get_hook() {
		$this->assertEquals( 'remember_me_controls__example-hook', $this->obj->get_hook( 'example-hook' ) );
	}
	...
	public function test_display_option_short_text_field() {
		...
		$expected = '<input type="text" class="c2c-short_text small-text" id="shorttextfield" name="c2c_remember_me_controls[shorttextfield]" value="25" />'
			. "\n"
