...
class Remember_Me_Controls_Test extends WP_UnitTestCase {
	...
	public function test_plugin_framework_class_name() {
		$this->assertTrue( class_exists( 'c2c_RememberMeControls_Plugin_049' ) );
	}

	public function test_plugin_framework_version() {
		$this->assertEquals( '049', c2c_RememberMeControls::get_instance()->c2c_plugin_version() );
	}

	public function test_get_version() {
		$this->assertEquals( '1.8', c2c_RememberMeControls::get_instance()->version() );
	}
